...
CREATE POLICY IF NOT EXISTS "Enable read access for all users" ON categories
  FOR SELECT USING (true);

-- Verification queries (run these after to confirm)
-- SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'books' AND column_name = 'category';
